...
Verivann does. When a source says something about the future that could be judged
...
impossible.
    ...
    verivann predictions            what is open, what came due
    verivann resolve <id> --miss    "he was wrong"  → the source carries it forever
"""
