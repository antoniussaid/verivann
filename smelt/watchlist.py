...
if you already suspected something. Smelt does the suspecting for you: it re-reads
what you told it to watch and shows you **what changed**, in the words that
changed.

    smelt watch add <url>     put a source under observation
    smelt watch run           re-read them all; changed ones produce a fresh note
    smelt watch list          what is being watched, and when it last moved
