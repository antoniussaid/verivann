...
evidence over weeks, and when you ask for it, Smelt synthesizes what its sources
collectively say, names where they disagree, and states what is still missing.

    smelt question add "Which broker is cheapest for ETFs in Austria?"
    smelt question list                 open questions, with the evidence each has
    smelt question answer 1             the synthesis, with sources and gaps
