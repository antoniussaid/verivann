...
`smelt calibrate` measures the *router* against your verdicts. The obvious next step
was sitting there the whole time: **make the models compete.**

    smelt bakeoff --models llama-3.3-70b,gpt-4o-mini --notes 20
...
judge those notes over the following days, `smelt bakeoff --results` tells you which
    ...
    def verdict(self) -> str:
        ...
        if not self.ready:
            ...
            return (
                ...
                f"{MIN_JUDGED} are needed. Judge more (`smelt list`, then keep/drop) and ask again."
            )
