...
Smelt had no migration path at all, which is an adoption blocker and a wasted
...
never came true.
    ...
    smelt import urls <file>          a Pocket / Raindrop / Instapaper export, or any list
    smelt import obsidian <vault>     every note you have already written
    smelt import history              the pages you actually came back to
