...
Point Smelt at your screenshots folder, your voice-memo folder, your downloads.
...
running it again is cheap and never produces a duplicate.
    ...
    smelt folder ~/Pictures/Screenshots          once
    smelt folder ~/Pictures/Screenshots --watch  keep watching (poll)
