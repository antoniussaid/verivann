...
claims forever, with the same confidence, long after the world moved on. Smelt has
...
`smelt refresh` walks every note something has happened to, and writes what
...
you delete Smelt tomorrow, the warning is still legible in your vault.
"""
